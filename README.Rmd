...
The length $L_{img}$ between the two points plotted on the image during the scaling process is calculated using Pythagorean Theorem. Using an entered value of real world length $L_{real}$, a scaling coefficient is calculated by dividing the image line length $L_{img}$ by the real-world length $L_{real}$

$$C = \frac{L_{img}}{L_{real}}$$
...
theme_dtavern <-   theme(panel.background = element_rect(fill = "white"),
                         ...
                         axis.title.y = element_text(size = 24, margin = margin(10,10,5,10)),
                         axis.text.x = element_text(face = "bold", size = 18),
                         axis.text.y = element_text(face = "bold", size = 18),
                         legend.key = element_rect(fill = "white"),
                         legend.text = element_text(size = 18),
                         legend.position = c(0.8, 0.2)) 
theme_dtavern1 <-   theme(panel.background = element_rect(fill = "white"),
                         axis.line.y = element_line(colour="black", size = 0.25),
                         axis.line.x = element_line(colour="black", size = 0.25),
                         axis.title.x = element_text(size = 24),
                         axis.title.y = element_text(size = 24, margin = margin(10,10,5,10)),
...
dtavern_facet9 <-   theme(panel.background = element_rect(fill = "white"),
                          axis.line.y = element_line(colour="black", size = 0.25),
                          axis.line.x = element_line(colour="black", size = 0.25),
                          axis.title.x = element_text(size = 16),
                          axis.title.y = element_text(size = 16, margin = margin(10,10,5,10)),
                          axis.text.x = element_text(face = "bold", size = 12),
                          axis.text.y = element_text(face = "bold", size = 12),
                          legend.key = element_rect(fill = "white"),
                          legend.text = element_text(size = 18),
                          legend.position = "none")
dtavern_facet9_leg <-   theme(panel.background = element_rect(fill = "white"),
                          axis.line.y = element_line(colour="black", size = 0.25),
                          axis.line.x = element_line(colour="black", size = 0.25),
                          axis.title.x = element_text(size = 16),
                          axis.title.y = element_text(size = 16, margin = margin(10,10,5,10)),
